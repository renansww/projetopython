...
#primeiro cria um dicionario temporario pra depois add na lista principal
...
def relatorio_geral():
# cursos, disciplinas, professores e alunos cadastrados.
...
#
#
#GALERA AQUI VAI TER MAIS COISA TA MAS EU NAO FIZ AINDA TA TA TA TATA 
#
#
#
...
def sistema():
    while True:
        ...
        # elif opcao == "10":
        #     relatorio_notas_aluno()               ainda nao tem
        # elif opcao == "11":
        #     emitir_certificado()
        elif opcao == "0":
